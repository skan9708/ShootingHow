...
options = {
  ...
  plotOptions: { bar: { horizontal: !0, barHeight: "24%" } },
  colors: ["#0576b9"],
  xaxis: { type: "datetime" },
};
(chart = new ApexCharts(
...
(chart = new ApexCharts(
  document.querySelector("#timelinedistributed-chart"),
  options
)).render();
options = {
  series: [
  ...
  chart: { type: "candlestick", height: 350, toolbar: { show: !1 } },
  plotOptions: {
    candlestick: { colors: { upward: "#0576b9", downward: "#f06548" } },
  },
  xaxis: { type: "datetime" },
...
options = {
  ...
  responsive: [{ breakpoint: 380, options: { legend: {position: "absolute", left: "180px", top: "35px", show: !1 } } }],
};
(chart = new ApexCharts(
  document.querySelector("#radial-angle-chart"),
  options
)).render();
options = {
...
(chart = new ApexCharts(
  document.querySelector("#radar-multiple-chart"),
  options
)).render();
options = {
...
(chart = new ApexCharts(
  document.querySelector("#polararea-monochrome-chart"),
  options
)).render();

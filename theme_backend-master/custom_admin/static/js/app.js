...
(function ($) {
  ...
  function layoutSetting() {
    ...
    $("input[name='layout']").on("change", function () {
      ...
      var hori = "Layout/Horizontal"
      window.location.href =
        $(this).val() == "vertical" ? "../" : "../../" + hori;
    });
  ...
  $(document).on("click", "#ui-elements", function (e) {
    $(".main-content").attr("overflow", "visible");
    return;
  });
...
$('#user-register').on('click', function (e) {
  ...
  if (email && username && password && confirm_password != '') {
    if (password.length < 6 || confirm_password < 6) {
      ...
      // $("#err-msg").append("<strong>Password must be at least 6 characters</strong>");
    ...
    $("#err-msg").removeAttr("hidden");
    $("#err-msg").addClass("alert alert-danger");
    $("#msg_err").text('Some fields are empty!');
  }
});
...
$('#user-login').on('click', function (e) {
  ...
  if (username && password != ''){
    ...
    $("#err-msg").removeAttr("hidden");
    $("#err-msg").addClass("alert alert-danger");
    $("#msg_err").text('아이디와 비밀번호를 모두 입력해주세요!');
  }
});
...
$('#lock-screen-login').on('click', function (e) {
  ...
  if (password != '') {
    ...
    $("#err-msg").removeAttr("hidden");
    $("#err-msg").addClass("alert alert-danger");
    $("#msg_err").text('Password field is empty!');
  }
});

// 쿠폰 삭제
$("#admin_user-remove").click(function(){
...
$("#purchase_request_detail-remove").click(function(){
  ...
  // 쿠폰 생성
  $("#admin-user-create").click(function(){
    ...
    formData.append("fullname", document.getElementById("admin_name").value)
    ...
    $.ajax({
      type: "POST",
      url: "/ktcsaipg/user/manager/create/", // 통신할 url을 지정
      success: function(response){ 
        location.href = "/ktcsaipg/user/manager/"
...
$("#admin-user-update").click(function(){
    ...
    // console.log("The file name is:",f_obj.name);
    // console.log("The file size is:",f_obj.size);
    var obj_id = document.getElementById("admin-user-update").value
    ...
    $.ajax({
      type: "put",
      url: "/ktcsaipg/user/manager/update/" + obj_id + "/", // 통신할 url을 지정
      success: function(response){ 
        location.href = "/ktcsaipg/user/manager/"

...
const MAX_UID = 1e6,
  ...
  defineJQueryPlugin = (e, t) => {
    var n;
    (n = () => {
      const n = getjQuery();
      if (n) {
        const i = n.fn[e];
        (n.fn[e] = t.jQueryInterface),
          (n.fn[e].Constructor = t),
          (n.fn[e].noConflict = () => ((n.fn[e] = i), t.jQueryInterface));
      }
    }),
      "loading" === document.readyState
...
function bootstrapDelegationHandler(e, t, n) {
  return function i(s) {
    ...
    for (let { target: t } = s; t && t !== this; t = t.parentNode)
      for (let r = o.length; r--; )
        if (o[r] === t)
          return (
            (s.delegateTarget = t),
            i.oneOff && EventHandler.off(e, s.type, n),
            n.apply(t, [s])
          );
    return null;
  };
...
function removeNamespacedHandlers(e, t, n, i) {
  ...
  Object.keys(s).forEach((o) => {
    if (o.includes(i)) {
      const i = s[o];
      removeHandler(e, t, n, i.originalHandler, i.delegationSelector);
    }
  });
}
const EventHandler = {
    ...
    off(e, t, n, i) {
      if ("string" != typeof t || !e) return;
      const [s, o, r] = normalizeParams(t, n, i),
        a = r !== t,
        l = getEvent(e),
        c = t.startsWith(".");
      if (void 0 !== o) {
...
class Alert extends BaseComponent {
  ...
  _removeElement(e) {
    ...
    const t = getTransitionDurationFromElement(e);
    EventHandler.one(e, "transitionend", () => this._destroyElement(e)),
      emulateTransitionEnd(e, t);
  }
  _destroyElement(e) {
...
class Button extends BaseComponent {
  ...
  static jQueryInterface(e) {
    return this.each(function () {
      let t = Data.get(this, DATA_KEY$a);
...
class Carousel extends BaseComponent {
  ...
  to(e) {
    ...
    const n = e > t ? ORDER_NEXT : ORDER_PREV;
  ...
  _getConfig(e) {
    return (
      (e = { ...Default$8, ...e }), typeCheckConfig(NAME$9, e, DefaultType$8), e
    );
  }
  _handleSwipe() {
  ...
  _addTouchEventListeners() {
    ...
    SelectorEngine.find(SELECTOR_ITEM_IMG, this._element).forEach((e) => {
      ...
      this._pointerEvent
        ? (EventHandler.on(this._element, EVENT_POINTERDOWN, (t) => e(t)),
          EventHandler.on(this._element, EVENT_POINTERUP, (e) => n(e)),
          this._element.classList.add("pointer-event"))
        : (EventHandler.on(this._element, EVENT_TOUCHSTART, (t) => e(t)),
          EventHandler.on(this._element, EVENT_TOUCHMOVE, (e) => t(e)),
          EventHandler.on(this._element, EVENT_TOUCHEND, (e) => n(e)));
  }
  _keydown(e) {
    /input|textarea/i.test(e.target.tagName) ||
      ("ArrowLeft" === e.key
        ? (e.preventDefault(), this._slide(DIRECTION_LEFT))
        : "ArrowRight" === e.key &&
          (e.preventDefault(), this._slide(DIRECTION_RIGHT)));
  }
  _getItemIndex(e) {
    return (
      (this._items =
  ...
  _slide(e, t) {
    ...
    else if (!this._triggerSlideEvent(o, d).defaultPrevented && i && o) {
      if (
        ((this._isSliding = !0),
        a && this.pause(),
        ...
        const e = getTransitionDurationFromElement(i);
        EventHandler.one(i, "transitionend", () => {
          o.classList.remove(c, E),
            o.classList.add("active"),
            i.classList.remove("active", E, c),
            (this._isSliding = !1),
            setTimeout(() => {
  ...
  static carouselInterface(e, t) {
    let n = Data.get(e, DATA_KEY$9),
      i = { ...Default$8, ...Manipulator.getDataAttributes(e) };
    "object" == typeof t && (i = { ...i, ...t });
    const s = "string" == typeof t ? t : i.slide;
    if ((n || (n = new Carousel(e, i)), "number" == typeof t)) n.to(t);
  ...
  static dataApiClickHandler(e) {
    ...
    i && (n.interval = !1),
      Carousel.carouselInterface(t, n),
      i && Data.get(t, DATA_KEY$9).to(i),
      e.preventDefault();
  }
}
EventHandler.on(
...
const NAME$8 = "collapse",
  ...
  Default$7 = { toggle: !0, parent: "" },
  DefaultType$7 = { toggle: "boolean", parent: "(string|element)" },
...
class Collapse extends BaseComponent {
  constructor(e, t) {
    super(e),
      ...
      (this._triggerArray = SelectorEngine.find(
        `${SELECTOR_DATA_TOGGLE$4}[href="#${this._element.id}"],${SELECTOR_DATA_TOGGLE$4}[data-bs-target="#${this._element.id}"]`
      ));
    const n = SelectorEngine.find(SELECTOR_DATA_TOGGLE$4);
    for (let e = 0, t = n.length; e < t; e++) {
      const t = n[e],
        i = getSelectorFromElement(t),
        s = SelectorEngine.find(i).filter((e) => e === this._element);
      null !== i &&
        s.length &&
  ...
  show() {
    ...
    let e, t;
    this._parent &&
      ((e = SelectorEngine.find(SELECTOR_ACTIVES, this._parent).filter((e) =>
        "string" == typeof this._config.parent
          ? e.getAttribute("data-bs-parent") === this._config.parent
          : e.classList.contains("collapse")
      )),
      0 === e.length && (e = null));
    const n = SelectorEngine.findOne(this._selector);
    if (e) {
      const i = e.find((e) => n !== e);
      if (((t = i ? Data.get(i, DATA_KEY$8) : null), t && t._isTransitioning))
        return;
    }
    ...
    e &&
      e.forEach((e) => {
        n !== e && Collapse.collapseInterface(e, "hide"),
          t || Data.set(e, DATA_KEY$8, null);
      });
    ...
    EventHandler.one(this._element, "transitionend", () => {
      ...
      emulateTransitionEnd(this._element, o),
    ...
    if (t > 0)
      for (let e = 0; e < t; e++) {
        const t = this._triggerArray[e],
          n = getElementFromSelector(t);
        n &&
          !n.classList.contains("show") &&
          (t.classList.add("collapsed"), t.setAttribute("aria-expanded", !1));
      }
  ...
  _getConfig(e) {
    return (
      ((e = { ...Default$7, ...e }).toggle = Boolean(e.toggle)),
  ...
  _getParent() {
    ...
    isElement(e)
      ...
      : (e = SelectorEngine.findOne(e));
    const t = `${SELECTOR_DATA_TOGGLE$4}[data-bs-parent="${e}"]`;
    return (
      SelectorEngine.find(t, e).forEach((e) => {
...
EventHandler.on(
  ...
  function (e) {
    ...
    SelectorEngine.find(n).forEach((e) => {
      const n = Data.get(e, DATA_KEY$8);
      let i;
      n
        ? (null === n._parent &&
          ...
          (i = "toggle"))
        : (i = t),
        Collapse.collapseInterface(e, i);
    });
  }
),
...
class Dropdown extends BaseComponent {
  ...
  show() {
    if (
      ...
      return;
    const e = Dropdown.getParentFromElement(this._element),
      t = { relatedTarget: this._element };
    if (
      !EventHandler.trigger(this._element, EVENT_SHOW$4, t).defaultPrevented
    ) {
      if (this._inNavbar)
        ...
        (this._popper = Popper.createPopper(t, this._menu, n)),
          i && Manipulator.setDataAttribute(this._menu, "popper", "static");
      }
      "ontouchstart" in document.documentElement &&
        ...
        []
          ...
          .forEach((e) =>
            EventHandler.on(e, "mouseover", null, function () {})
          ),
        this._element.focus(),
        this._element.setAttribute("aria-expanded", !0),
        this._menu.classList.toggle("show"),
        this._element.classList.toggle("show"),
        EventHandler.trigger(this._element, EVENT_SHOWN$4, t);
    }
  }
  hide() {
    if (
  ...
  _addEventListeners() {
    EventHandler.on(this._element, EVENT_CLICK, (e) => {
  ...
  _getConfig(e) {
    if (
      ...
      typeCheckConfig(NAME$7, e, this.constructor.DefaultType),
  ...
  static dropdownInterface(e, t) {
    let n = Data.get(e, DATA_KEY$7);
    if (
      (n || (n = new Dropdown(e, "object" == typeof t ? t : null)),
      "string" == typeof t)
    ) {
      if (void 0 === n[t]) throw new TypeError(`No method named "${t}"`);
      n[t]();
  ...
  static clearMenus(e) {
    ...
    for (let n = 0, i = t.length; n < i; n++) {
      const i = Data.get(t[n], DATA_KEY$7),
        s = { relatedTarget: t[n] };
      ...
      if (t[n].classList.contains("show")) {
        ...
        EventHandler.trigger(t[n], EVENT_HIDE$4, s).defaultPrevented ||
          ("ontouchstart" in document.documentElement &&
            []
              .concat(...document.body.children)
              .forEach((e) =>
                EventHandler.off(e, "mouseover", null, function () {})
              ),
          t[n].setAttribute("aria-expanded", "false"),
          i._popper && i._popper.destroy(),
          o.classList.remove("show"),
          t[n].classList.remove("show"),
          Manipulator.removeDataAttribute(o, "popper"),
          EventHandler.trigger(t[n], EVENT_HIDDEN$4, s));
      }
    }
  }
  ...
  static dataApiKeydownHandler(e) {
    ...
    if (
      ...
      return;
    const t = Dropdown.getParentFromElement(this),
    ...
    const i = SelectorEngine.find(SELECTOR_VISIBLE_ITEMS, t).filter(isVisible);
    if (!i.length) return;
    let s = i.indexOf(e.target);
    "ArrowUp" === e.key && s > 0 && s--,
      "ArrowDown" === e.key && s < i.length - 1 && s++,
      (s = -1 === s ? 0 : s),
      i[s].focus();
  }
}
...
class Modal extends BaseComponent {
  ...
  show(e) {
    ...
    const t = EventHandler.trigger(this._element, EVENT_SHOW$3, {
      relatedTarget: e,
    });
    this._isShown ||
      t.defaultPrevented ||
  ...
  hide(e) {
    ...
    if (
      ...
      const e = getTransitionDurationFromElement(this._element);
      EventHandler.one(this._element, "transitionend", (e) =>
        this._hideModal(e)
      ),
  ...
  _getConfig(e) {
    return (
      (e = { ...Default$5, ...e }), typeCheckConfig(NAME$6, e, DefaultType$5), e
    );
  }
  _showElement(e) {
    const t = this._isAnimated(),
    ...
    if (t) {
      const e = getTransitionDurationFromElement(this._dialog);
      EventHandler.one(this._dialog, "transitionend", i),
        emulateTransitionEnd(this._dialog, e);
    } else i();
  }
  _enforceFocus() {
    EventHandler.off(document, EVENT_FOCUSIN$1),
      EventHandler.on(document, EVENT_FOCUSIN$1, (e) => {
        document === e.target ||
  ...
  _showBackdrop(e) {
    ...
    if (this._isShown && this._config.backdrop) {
      if (
        ...
        EventHandler.on(this._element, EVENT_CLICK_DISMISS$2, (e) => {
        ...
        t && reflow(this._backdrop),
        this._backdrop.classList.add("show"),
        !t)
      )
        return void e();
      const n = getTransitionDurationFromElement(this._backdrop);
      EventHandler.one(this._backdrop, "transitionend", e),
        emulateTransitionEnd(this._backdrop, n);
      ...
      if (t) {
        const e = getTransitionDurationFromElement(this._backdrop);
        EventHandler.one(this._backdrop, "transitionend", n),
          emulateTransitionEnd(this._backdrop, e);
      } else n();
    } else e();
  }
  _isAnimated() {
  ...
  _triggerBackdropTransition() {
    ...
    const t = getTransitionDurationFromElement(this._dialog);
  ...
  _setElementAttributes(e, t, n) {
    SelectorEngine.find(e).forEach((e) => {
      if (
        e !== document.body &&
      ...
      Manipulator.setDataAttribute(e, t, i),
  ...
  _resetElementAttributes(e, t) {
    SelectorEngine.find(e).forEach((e) => {
      ...
      void 0 === n && e === document.body
        ? (e.style[t] = "")
        : (Manipulator.removeDataAttribute(e, t), (e.style[t] = n));
    });
  }
  _getScrollbarWidth() {
...
const SELECTOR_FIXED_CONTENT = ".fixed-top, .fixed-bottom, .is-fixed",
  ...
  hide = (e = getWidth()) => {
    (document.body.style.overflow = "hidden"),
      ...
      _setElementAttributes(".sticky-top", "marginRight", (t) => t - e),
      _setElementAttributes("body", "paddingRight", (t) => t + e);
  },
  _setElementAttributes = (e, t, n) => {
    const i = getWidth();
    SelectorEngine.find(e).forEach((e) => {
      ...
      Manipulator.setDataAttribute(e, t, s),
  ...
  reset = () => {
    (document.body.style.overflow = "auto"),
      ...
      _resetElementAttributes(".sticky-top", "marginRight"),
...
class Offcanvas extends BaseComponent {
  ...
  _enforceFocusOnElement(e) {
    EventHandler.off(document, EVENT_FOCUSIN),
      EventHandler.on(document, EVENT_FOCUSIN, (t) => {
        document === t.target ||
          e === t.target ||
          e.contains(t.target) ||
          e.focus();
  ...
  _addEventListeners() {
    EventHandler.on(
      ...
      EventHandler.on(document, EVENT_CLICK_DATA_API$1, (e) => {
        const t = SelectorEngine.findOne(getSelectorFromElement(e.target));
  ...
  static jQueryInterface(e) {
    return this.each(function () {
      const t =
        Data.get(this, DATA_KEY$5) ||
        new Offcanvas(this, "object" == typeof e ? e : {});
      if ("string" == typeof e) {
...
EventHandler.on(
  ...
  function (e) {
    ...
    const n = SelectorEngine.findOne(ACTIVE_SELECTOR);
    (n && n !== t) ||
      (Data.get(t, DATA_KEY$5) || new Offcanvas(t)).toggle(this);
  }
),
  EventHandler.on(window, EVENT_LOAD_DATA_API$1, () => {
    SelectorEngine.find(OPEN_SELECTOR).forEach((e) =>
      (Data.get(e, DATA_KEY$5) || new Offcanvas(e)).show()
    );
  }),
...
class Tooltip extends BaseComponent {
  ...
  show() {
    ...
    i.setAttribute("id", s),
      ...
      this.setContent(),
      this.config.animation && i.classList.add("fade");
    const o =
        "function" == typeof this.config.placement
          ? this.config.placement.call(this, i, this._element)
          : this.config.placement,
      r = this._getAttachment(o);
    this._addAttachmentClass(r);
    const a = this._getContainer();
    Data.set(i, this.constructor.DATA_KEY, this),
    ...
    if (this.tip.classList.contains("fade")) {
      const e = getTransitionDurationFromElement(this.tip);
      EventHandler.one(this.tip, "transitionend", c),
        emulateTransitionEnd(this.tip, e);
    } else c();
  }
  hide() {
  ...
  getTipElement() {
    ...
    const e = document.createElement("div");
    return (
      (e.innerHTML = this.config.template), (this.tip = e.children[0]), this.tip
    );
  }
  setContent() {
    const e = this.getTipElement();
    this.setElementContent(
      SelectorEngine.findOne(".tooltip-inner", e),
      this.getTitle()
    ),
  ...
  setElementContent(e, t) {
    if (null !== e)
      return "object" == typeof t && isElement(t)
        ? (t.jquery && (t = t[0]),
  ...
  _initializeOnDelegatedTarget(e, t) {
    ...
    return (
      (t = t || Data.get(e.delegateTarget, n)) ||
        ((t = new this.constructor(
          e.delegateTarget,
          this._getDelegateConfig()
        )),
        Data.set(e.delegateTarget, n, t)),
      t
    );
  }
  _getOffset() {
  ...
  _setListeners() {
    this.config.trigger.split(" ").forEach((e) => {
      if ("click" === e)
        ...
        EventHandler.on(this._element, t, this.config.selector, (e) =>
          this._enter(e)
        ),
          EventHandler.on(this._element, n, this.config.selector, (e) =>
            this._leave(e)
          );
      }
    }),
  ...
  static jQueryInterface(e) {
    return this.each(function () {
      let t = Data.get(this, DATA_KEY$4);
      const n = "object" == typeof e && e;
      if (
        (t || !/dispose|hide/.test(e)) &&
        (t || (t = new Tooltip(this, n)), "string" == typeof e)
      ) {
...
class Popover extends Tooltip {
  ...
  setContent() {
    ...
    "function" == typeof t && (t = t.call(this._element)),
      this.setElementContent(SelectorEngine.findOne(".popover-body", e), t),
      e.classList.remove("fade", "show");
  }
  _addAttachmentClass(e) {
    this.getTipElement().classList.add(
  ...
  static jQueryInterface(e) {
    return this.each(function () {
      let t = Data.get(this, DATA_KEY$3);
      const n = "object" == typeof e ? e : null;
      if (
        (t || !/dispose|hide/.test(e)) &&
        (t || ((t = new Popover(this, n)), Data.set(this, DATA_KEY$3, t)),
        "string" == typeof e)
      ) {
        if (void 0 === t[e]) throw new TypeError(`No method named "${e}"`);
        t[e]();
...
class ScrollSpy extends BaseComponent {
  ...
  refresh() {
    ...
    (this._offsets = []),
      ...
      SelectorEngine.find(this._selector)
        .map((e) => {
          const i = getSelectorFromElement(e),
            s = i ? SelectorEngine.findOne(i) : null;
          if (s) {
            const e = s.getBoundingClientRect();
            if (e.width || e.height) return [Manipulator[t](s).top + n, i];
          }
          return null;
        })
        .filter((e) => e)
  ...
  _getConfig(e) {
    if (
      "string" !=
        typeof (e = { ...Default$1, ...("object" == typeof e && e ? e : {}) })
          .target &&
      isElement(e.target)
    ) {
      let { id: t } = e.target;
  ...
  _activate(e) {
    ...
    n.classList.contains("dropdown-item")
      ...
      : (n.classList.add("active"),
        SelectorEngine.parents(n, ".nav, .list-group").forEach((e) => {
  ...
  static jQueryInterface(e) {
    return this.each(function () {
      let t = Data.get(this, DATA_KEY$2);
      if (
        (t || (t = new ScrollSpy(this, "object" == typeof e && e)),
        "string" == typeof e)
      ) {
        if (void 0 === t[e]) throw new TypeError(`No method named "${e}"`);
        t[e]();
...
EventHandler.on(window, EVENT_LOAD_DATA_API, () => {
  SelectorEngine.find(SELECTOR_DATA_SPY).forEach(
    (e) => new ScrollSpy(e, Manipulator.getDataAttributes(e))
  );
}),
...
class Tab extends BaseComponent {
    ...
    if (n) {
      const t =
        "UL" === n.nodeName || "OL" === n.nodeName
          ? SELECTOR_ACTIVE_UL
          : ".active";
      (e = SelectorEngine.find(t, n)), (e = e[e.length - 1]);
    }
    const i = e
  ...
  _activate(e, t, n) {
    ...
    if (i && s) {
      ...
      i.classList.remove("show"),
        EventHandler.one(i, "transitionend", o),
        emulateTransitionEnd(i, e);
    } else o();
  }
  _transitionComplete(e, t, n) {
    ...
    e.classList.add("active"),
      ...
      e.parentNode &&
        ...
        (e.closest(".dropdown") &&
          SelectorEngine.find(".dropdown-toggle").forEach((e) =>
            e.classList.add("active")
          ),
  ...
  static jQueryInterface(e) {
    return this.each(function () {
      const t = Data.get(this, "bs.tab") || new Tab(this);
      if ("string" == typeof e) {
        if (void 0 === t[e]) throw new TypeError(`No method named "${e}"`);
        t[e]();
      }
...
class Toast extends BaseComponent {
  ...
  show() {
    ...
    if (
      ...
      const t = getTransitionDurationFromElement(this._element);
      EventHandler.one(this._element, "transitionend", e),
        emulateTransitionEnd(this._element, t);
    } else e();
  }
  ...
  static jQueryInterface(e) {
    return this.each(function () {
      let t = Data.get(this, DATA_KEY);
      if (
        (t || (t = new Toast(this, "object" == typeof e && e)),
        "string" == typeof e)
      ) {
        if (void 0 === t[e]) throw new TypeError(`No method named "${e}"`);
        t[e](this);

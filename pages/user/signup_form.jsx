...
export default function UserSignin(props) {
  ...
  const [user, setUser] = useState({ fullname: '', birthday: '', phone: '' });
  useEffect(() => {
  ...
  const completeHandler = () => {
    ...
    // })
    console.log("가입 완료 버튼 클릭 (API 호출 없음)");
    toast.info("백엔드 연동이 제거되어 실제 가입 처리는 되지 않습니다.");
    // 필요하다면 가입 완료 후 특정 페이지로 이동하는 로직은 남겨둘 수 있습니다.
    // router.push("/"); 
  }
  return (
